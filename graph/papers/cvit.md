...
## Key Contributions
- Formulates and evaluates `cvit` for scientific machine learning and neural operator problems.
- Validated on standardized benchmarks with reproducible empirical metrics.

## Open Source Repository
- Implementation: `https://github.com/PredictiveIntelligenceLab/cvit`
