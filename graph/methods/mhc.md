...
- **Single-Pass mHC in `method:deepseek-v41-flash`**: Serving-kernel revision of residual-stream mixing (Mega-mHC) inside the V4.1-Flash CED stack. Does not supersede this mHC node or retarget DeepSeek-V4.
